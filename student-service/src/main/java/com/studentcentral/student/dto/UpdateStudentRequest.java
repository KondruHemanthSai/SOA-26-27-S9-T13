...
public class UpdateStudentRequest {
    ...
    public UpdateStudentRequest(String firstName, String lastName, String phone, LocalDate dateOfBirth, String address, String program, String department, Integer enrollmentYear, Integer semester) {

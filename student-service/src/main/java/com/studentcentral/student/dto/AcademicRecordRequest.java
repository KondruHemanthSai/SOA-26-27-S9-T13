...
public class AcademicRecordRequest {
    ...
    @DecimalMax(value = "10.0", message = "CGPA cannot be greater than 10.0")
    private Double cgpa;

    @Min(value = 1950, message = "Graduation year must be a valid year")
    @Max(value = 2100, message = "Graduation year must be a valid year")
    private Integer graduationYear;

    public AcademicRecordRequest() {
    }

    public AcademicRecordRequest(String previousInstitution, String board, Double percentage, Double cgpa, Integer graduationYear) {
